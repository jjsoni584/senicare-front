...
import { deleteToolRequest, getToolListRequest, getToolRequest, patchToolRequest, postToolRequest } from '../../apis';
import { PatchToolRequestDto, PostToolRequestDto } from '../../apis/dto/request/tool';
import { ResponseDto } from '../../apis/dto/response';
import { Tool } from '../../types';
import { GetToolListResponseDto, GetToolResponseDto } from '../../apis/dto/response/tool';
...
function PatchBox({ toolNumber, unShow, getToolList }: PatchBoxProps) {
    ...
    function TableRow({ tool, getToolList, onUpdateButtonClickHandler }: TableRowProps) {
        ...
        const onDeleteButtonClickHandler = () => {
            // confirm: 확인과 취소가 있는 알림창 취소는 false//
