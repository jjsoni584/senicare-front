...
import { GetNurseListResponseDto } from '../../../apis/dto/response/nurse';
import { ResponseDto } from '../../../apis/dto/response';
import { ACCESS_TOKEN, CS_ABSOLUTE_PATH, CS_DETAIL_ABSOLUTE_PATH } from '../../../constants';
import { fileUploadRequest, getCustomerRequest, getNurseListRequest, patchCustomerRequest, postCustomerRequest } from '../../../apis';
import PostCustomerRequestDto from '../../../apis/dto/request/customer/post-customer.request.dto';
import Pagination from '../../../components/pagination';
import { GetCustomerResponseDto } from '../../../apis/dto/response/customer';
import { PatchCustomerRequestDto } from '../../../apis/dto/request/customer';
...
export default function CSUpdate() {
    ...
    // effect: 고객번호가 바뀔 시 요양사 리스트, 고객 정보 불러오기 함수 //
    useEffect(() => {
        if(!customerNumber){ 
            navigator(CS_ABSOLUTE_PATH)
            return;
    ...
    return (
        <div id='cs-write-wrapper'>
            ...
            <div className='bottom'>
                ...
                <div className='button second' onClick={onUpdateClickHandler}>등록</div>
            </div>
            {modalOpen &&
            <div className='modal'>
