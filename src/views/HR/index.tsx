...
import { ACCESS_TOKEN, HR_DETAIL_ABSOLUTE_PATH } from '../../constants';
import { getNurseListRequest } from '../../apis';
...
function TabelRow({nurse} : TableRowProps) {

    // state: 로그인 유저 상태 //
    const {signInUser} = useSignInUserStore();

    // variable: 본인 여부 //
    const inSignInUser = nurse.nurseId === signInUser ?.userId;
        ...
        <div id='hr-wrapper'>
            ...
            <div className='main'>
                <div className='table'>
                    ...
                    {viewList.map((nurse, index) => <TabelRow key={index} nurse={nurse}/>)}
                </div>
            </div>
